...
struct PackObjVtbl;
struct ArgumentParser_CommandLineArgList;
...
struct Cache_Pack_t;
struct AsyncCache_CAsyncRequest;
struct AsyncCache_CCallbackHandler;
...
struct CAsyncStateMachine_CAsyncStateData;
...
struct ClientCommunicationSystem_CmdHashData;
struct ClientCommunicationSystem;
struct ObjectRangeHandlerVtbl;
struct CCommunicationSystem_ChatInterfaceProvider;
...
struct InArchiveVersionStack_VersionRowHolder;
struct LogController_CategoryHandler;
...
struct CAllIterationList_PTaggedIterationList;
struct CAllIterationList_PTaggedIterationListVtbl;
struct StringTableMetaLanguage_Node;
...
typedef void* NDR_SCONTEXT;
typedef void* PARRAY_INFO;
typedef void* xmlelemTYPE;
...
typedef unsigned __int8* LPCSTR;
...
struct tagWNDCLASSA
{
	...
	unsigned __int8* lpszMenuName;
	unsigned __int8* lpszClassName;
};
...
typedef unsigned int _NDR_PIPE_DESC;
typedef _NDR_PIPE_DESC* PNDR_PIPE_DESC;


typedef unsigned int _NDR_ASYNC_MESSAGE;
...
union _MIDL_STUB_DESC_$5BCB627D3738D8B5DEACC268C24AE672
{
...
struct _MIDL_STUB_DESC
{
	...
	void* (__stdcall* pfnAllocate)(size_t);
	void(__stdcall* pfnFree)(void*);
	_MIDL_STUB_DESC_$5BCB627D3738D8B5DEACC268C24AE672 IMPLICIT_HANDLE_INFO;
...
struct _FULL_PTR_XLAT_TABLES_$CFFA09E862963CB530A7E2871127FDA7
{
	void* XlatTable;
...
struct _FULL_PTR_XLAT_TABLES_$5B5EF811252786EBFBAAA3889BB4C68D
{
...
enum E2A6324B8E10DEE2666A6A5498DFC667B
{
	XLAT_SERVER = 0x1,
	XLAT_CLIENT = 0x2,
};
...
typedef E2A6324B8E10DEE2666A6A5498DFC667B XLAT_SIDE;



struct _FULL_PTR_XLAT_TABLES
{
	_FULL_PTR_XLAT_TABLES_$CFFA09E862963CB530A7E2871127FDA7 RefIdToPointer;
	_FULL_PTR_XLAT_TABLES_$5B5EF811252786EBFBAAA3889BB4C68D PointerToRefId;
...
struct type_info
{
	void* vfptr;
	int _M_data;
	unsigned __int8 _M_d_name; //char _M_d_name[];
};


enum EFA310B393AFE23AC619E684616706237
{
	eInvalid = 0xFFFF,
};


typedef EFA310B393AFE23AC619E684616706237 E174D5E253DF64A9102706DE54571A8C0;
...
typedef unsigned int E0FC989869F227A36D749990E523E5F04;
typedef E0FC989869F227A36D749990E523E5F04 POWER_ACTION;

typedef unsigned int EC9C41CE7F7AB140BE1C872069B92FC11;
typedef EC9C41CE7F7AB140BE1C872069B92FC11 LATENCY_TIME;

typedef unsigned int E091388B5486C38E232712F2AD090397D;
typedef E091388B5486C38E232712F2AD090397D POWER_INFORMATION_LEVEL;
...
typedef unsigned int __MIDL_IBindStatusCallback_0004;
typedef __MIDL_IBindStatusCallback_0004 __MIDL_IBindStatusCallback_0006;


enum Logger_LoggerWriteResult
{
	res_WriteFailed = 0x0,
...
typedef unsigned int $13CC20D9AD0BBA5D63681FE6203B0C08;
...
typedef unsigned int $B2CD58BB5E151C37D855099D3E2FDD5A;
typedef $B2CD58BB5E151C37D855099D3E2FDD5A STUB_PHASE;

typedef unsigned int $0AEECC1A63E1B2F73D11FBA74082B60B;
typedef $0AEECC1A63E1B2F73D11FBA74082B60B PROXY_PHASE;


enum Turbine_Debug_AssertionControlBits
{
...
enum Turbine_Debug_DebugResponse
{
...
enum Turbine_Debug_OutputStringType
{
...
enum Archive_tagUnpacking
{
	Unpacking = 0x0,
};


enum Archive_tagPacking
{
	Packing = 0x0,
};
...
enum ArgumentParser_OutputTextType
{
	ottNormal = 0x0,
	ottErrorText = 0x1,
	ottShortVersion = 0x2,
...
typedef unsigned int $0AEECC1A63E1B2F73D11FBA74082B60B;
typedef unsigned int $92E343B9497C79C1DA0A7F8171886153;
typedef $92E343B9497C79C1DA0A7F8171886153 INTERNET_SCHEME;


enum _STL_locale__Category
{
	none = 0x0,
	collate = 0x10,
	ctype = 0x20,
...
//enum _STL_ctype<char>___TableSize
//{
//  table_size = 0x100,
//};

typedef unsigned int $D1D25F7E59039EE4F06FC6A15C79D0DD;
...
enum HttpClient__WinHttp_ImplementationType
{
	WinHttp_ImplementationType = 0x0,
};


enum HttpClient__WinInet_ImplementationType
{
